...
/// Read-only view of the delivery snapshot captured when the order
/// was created. Pre-migration orders don't have this block (the parent
/// checks `order.tieneSnapshotEntrega` before rendering us).
        ...
        children: [
          ...
          if (lat != null && lng != null) ...[
            ...
            Text(
              ...
              // ruta sin exponer un enlace externo aquí (el admin lo verá
              // en un mapa cuando se implemente el paso 9).
